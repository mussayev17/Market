...
class Product(models.Model):
    ...
    MAX_RESOLUTION =(250, 250)
    MAX_IMAGE_SIZE = 3145728

    #brand = models.CharField(max_length=255, verbose_name='Brand', default='default brand')
    ...
    def save(self, *args, **kwargs):
           ...
           self.image = InMemoryUploadedFile(filestream, 'ImageField', name,'jpeg/image',
